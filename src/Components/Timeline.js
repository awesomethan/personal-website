...
function Timeline() {
  return (
    <div>
      <h1 className="heading title">My Timeline</h1>
      <VerticalTimeline className="timeline">
        ...
        >
          ...
          <p>
            ...
            tournament, I was still rather proud of myself :D
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            way to the finals in boys doubles and earned a silver medal. One of
            my most memorable tournaments.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            nerve-racking for me, especially since I was responsible for an
            entire class of students. Nonetheless, I enjoyed the novel sense of
        ...
        >
          ...
          <p>
            During my fourth provincial badminton tournament, I won not just
            one, but two gold medals, as well as a bronze too.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            play simple songs while flashing lights. In addition, I later made
            it able to move in different patterns. Feel free to check out the
        ...
        >
          ...
          <p>
            ...
            made the honour roll by scoring 47/60 and placing in group V. Not
            the most extraordinary achievement, but still one that I was quite
            proud of.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            ...
            that I didn't put that much time in competitive programming back
            then, it wasn’t a horrible result.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            would be extremely tough; however, in retrospect, I actually wasted
            a lot of time over studying 😭
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            Microeconomics, Calculus BC, and Chemistry. Thanks to my hard work
            and studying, I was able to achieve a 5/5 score on all of them,
            which earned me an AP scholar award 😎
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            ...
            competitive programming trainer, so I enlightened club members on
            the fundamentals of competitive programming. You can find some of my
            resources{" "}
            <a
        ...
        >
          ...
          <p>
            ...
            COMC 2018, CIMC 2018, Pascal 2019, Fryer 2019, CIMC 2019, Cayley
            2020, CCC Junior 2020, COMC 2020, CCC Senior 2021, Fermat 2021, CSMC
            2021. I was a couple points from making honour roll on some of these
            contests, but oh well lol. These are not particularly notable
            achievements at all, but still awards nonetheless 😅
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            I achieved an IB score of 40/45. A little confused as to how I got a
            7 in French but 6 in chemistry but oh well! I think I did pretty
            well on my math, physics, and chemistry IAs, so you can read them{" "}
            <a
            ...
            if you're interested (my EE is a different story though, so I will
            not share it LOL)
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            I love playing badminton with friends to relieve stress and have
            fun, so to spend more time at the club, I decided to become an exec
            to help the club run more smoothly.
          </p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
